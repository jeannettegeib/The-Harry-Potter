...
let arrayOfPotterForSale = [];
arrayOfPotterForSale = toSellOrNotToSell(firedMug);
arrayOfPotterForSale = toSellOrNotToSell(firedBowl);
arrayOfPotterForSale = toSellOrNotToSell(firedNapkinRing);
arrayOfPotterForSale = toSellOrNotToSell(firedPlate);

console.log(arrayOfPotterForSale)
